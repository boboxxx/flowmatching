...
| 15 | 2026-09-19 | confirmatory | H2 DIV2K held-out matrix passes the central gate: NACK -1.296 pp, CI [-2.570,-0.0225]; PSNR +0.0206 dB; LPIPS +0.00132. Calibration balanced accuracy/ECE do not consistently improve, so the mechanism claim is limited to reduced held-out variance. |
| 16 | 2026-09-19 | external | Frozen Kodak24 evaluation with channel seeds 9001--9003 replicates the NACK saving: -2.025 pp, CI [-3.343,-0.708], with matched PSNR/LPIPS. No Kodak fitting or selection was performed. |
| 17 | 2026-09-19 | control-fix | The first H4 launch incorrectly evaluated a one-step model at midpoint time. It was cancelled, inference was aligned to the preregistered $t=0$ control, 21 tests passed, and corrected jobs 11397243--11397245 were launched into isolated `one_shot_t0` outputs. |
| 18 | 2026-09-19 | mechanism-control | Corrected H4 completed. The best one-step $t=0$ control changes PSNR by -0.0147 dB (95% CI [-0.0232,-0.0055]) and LPIPS by +0.00093, whereas four-step RAFM gives +0.0714 dB. The 0.0861 dB gap passes the preregistered 0.02 dB flow-specificity gate. |
| 17 | 2026-09-19 | protocol | Locked and launched H4 parameter-matched one-shot residual control (`11397232`--`11397234`) and final K=4 latency benchmark (`11397235`). |
